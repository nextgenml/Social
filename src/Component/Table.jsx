...
const Table = ({ Icon, IconClass }) => {
  return (
    <div className="flex flex-wrap justify-center mt-5 gap-x-10 ">
      <div className="overflow-hidden rounded-lg shadow-xs w-200">
                ...
                <tr className="text-gray-700 bg-gray-50 hover:bg-gray-100 ">
                  <td className="px-1 py-3">
                    <div className="flex items-center content-center text-sm">
                      <div className="w-8 h-8 px-2 mr-3 rounded-full ">
                        <Icon className={`text-xl mt-2 ${IconClass}`} />
                      </div>
                      <div>
                  ...
                  <td className="py-3 text-sm px-">Engagement</td>
                </tr>
              ))}
            </tbody>
          </table>
